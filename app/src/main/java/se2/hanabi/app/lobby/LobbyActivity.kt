...
fun LobbyScreen (playerList: List<String>, onLeaveLobby: () -> Unit){
    ...
    Column (modifier = Modifier.fillMaxSize()){
        Box(modifier = Modifier.fillMaxWidth().height(56.dp).background(Color.DarkGray), contentAlignment = Alignment.CenterStart)
               { Text (
            text = "Lobby",
            color = Color.White,
        ...
        Button(
           ...
           containerColor = Color.DarkGray
            ...
            modifier = Modifier.padding(top = 16.dp).width(200.dp).height(60.dp)
        ) {
